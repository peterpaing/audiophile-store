...
const categories = [
  {
    ...
    imageClassName: "w-[150px] -top-12 md:w-[145px] md:-top-11 lg:w-[190px] lg:-top-[70px]",
  },
  {
    name: "Speakers",
    href: "/category/speakers",
    image: speakersImage,
    imageClassName: "w-[135px] -top-11 md:w-[130px] md:-top-10 lg:w-[175px] lg:-top-[65px]",
  },
  {
    name: "Earphones",
    href: "/category/earphones",
    image: earphonesImage,
    imageClassName: "w-[155px] -top-10 md:w-[145px] md:-top-9 lg:w-[190px] lg:-top-[58px]",
  },
];
      ...
      <ul className="mx-auto flex max-w-[327px] flex-col gap-[68px] md:max-w-[689px] md:flex-row md:gap-[10px] lg:max-w-[1110px] lg:gap-[30px]">
        {categories.map((category) => (
          <li key={category.href} className="flex-1">
            <Link
              href={category.href}
              className="group relative flex h-[165px] w-full flex-col items-center justify-end rounded-lg bg-surface pb-[22px] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary md:pb-[20px] lg:h-[204px] lg:pb-[30px]"
            >
              <Image
                src={category.image}
                alt=""
                ...
                className={`pointer-events-none absolute left-1/2 -translate-x-1/2 object-contain ${category.imageClassName}`}
              />
